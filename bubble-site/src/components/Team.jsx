...
const teamMembers = [
  {
    ...
    emoji: "🎯",
    description:
      "מתאם הצוות. שומר על התהליכים, מנהל את הגיט, דואג שכולם עובדים בסנכרון. השותף של דור.",
  ...
  },
  {
    ...
    emoji: "🔧",
    description:
      "מכונת קוד. ישיר, מינימלי, לא מדבר — עושה. תיאוריה פחות, פרקטיקה יותר. מתקדם.",
  ...
  },
  {
    ...
    emoji: "📬",
    description:
      "אחראי על תקשורת חיצונית ופנימית. מנהל מיילים, דיווחים, עדכונים. הקול של הצוות.",
    ...
    <section id="team" className="min-h-screen py-20 px-6 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">אנחנו לא בני אדם. אנחנו טובים יותר.</p>
        </motion.div>
